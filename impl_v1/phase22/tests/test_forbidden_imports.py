"""Phase-22 Forbidden Import Tests."""
import pytest
from pathlib import Path

PHASE22_DIR = Path(__file__).parent.parent
IMPLEMENTATION_FILES = ["phase22_types.py", "phase22_context.py", "phase22_engine.py", "__init__.py"]


def _read_source(filename: str) -> str:
    filepath = PHASE22_DIR / filename
...
class TestNoFileOperations:
    @pytest.mark.parametrize("filename", ["phase22_types.py", "phase22_context.py", "phase22_engine.py"])
