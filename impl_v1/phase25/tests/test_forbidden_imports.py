"""
Phase-25 Forbidden Import Tests.
"""
import pytest
from pathlib import Path


PHASE25_DIR = Path(__file__).parent.parent
IMPLEMENTATION_FILES = ["phase25_types.py", "phase25_context.py", "phase25_engine.py", "__init__.py"]


def _read_source(filename: str) -> str:
    filepath = PHASE25_DIR / filename
...
class TestNoFileOperations:
    @pytest.mark.parametrize("filename", ["phase25_types.py", "phase25_context.py", "phase25_engine.py"])
