"""Phase-35 Forbidden Import Tests."""
import pytest
from pathlib import Path

PHASE35_DIR = Path(__file__).parent.parent
IMPLEMENTATION_FILES = ["phase35_types.py", "phase35_context.py", "phase35_engine.py", "__init__.py"]


def _read_source(filename: str) -> str:
    filepath = PHASE35_DIR / filename
...
class TestNoFileOperations:
    @pytest.mark.parametrize("filename", ["phase35_types.py", "phase35_context.py", "phase35_engine.py"])
