"""
Phase-27 Forbidden Import Tests.
...
PHASE27_DIR = Path(__file__).parent.parent
...
class TestNoFileOperations:
    ...
    @pytest.mark.parametrize("filename", ["phase27_types.py", "phase27_context.py", "phase27_engine.py"])
