"""
Phase-32 Forbidden Import Tests.
...
PHASE32_DIR = Path(__file__).parent.parent
...
class TestForbiddenImports:
    ...
    @pytest.mark.parametrize("filename", IMPLEMENTATION_FILES)
    def test_no_phase33_import(self, filename: str) -> None:
        """No phase33+ imports."""
...
class TestNoFileOperations:
    ...
    @pytest.mark.parametrize("filename", ["phase32_types.py", "phase32_context.py", "phase32_engine.py"])
