"""
Phase-34 Authorization Context.

This module defines frozen dataclasses for execution authorization.
...
CORE RULES:
- ExecutionAuthorization is immutable
- Authorization comes from valid intent
...
from .authorization_types import AuthorizationStatus
...
class ExecutionAuthorization:
    ...
    Attributes:
        ...
        authorized_by: Human who authorized (from intent.created_by)
