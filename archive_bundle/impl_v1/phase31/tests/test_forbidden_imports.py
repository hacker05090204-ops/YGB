"""
Phase-31 Forbidden Import Tests.
...
PHASE31_DIR = Path(__file__).parent.parent
...
class TestForbiddenImports:
    ...
    @pytest.mark.parametrize("filename", IMPLEMENTATION_FILES)
    def test_no_phase32_import(self, filename: str) -> None:
        """No phase32+ imports."""
...
class TestNoFileOperations:
    ...
    @pytest.mark.parametrize("filename", ["phase31_types.py", "phase31_context.py", "phase31_engine.py"])
