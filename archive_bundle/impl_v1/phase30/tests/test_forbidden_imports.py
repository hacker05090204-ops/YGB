"""
Phase-30 Forbidden Import Tests.
...
PHASE30_DIR = Path(__file__).parent.parent
...
class TestNoFileOperations:
    ...
    @pytest.mark.parametrize("filename", ["phase30_types.py", "phase30_context.py", "phase30_engine.py"])
